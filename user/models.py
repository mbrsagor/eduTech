...
class User(AbstractUser, Timestamp):
    ...
    role = models.IntegerField(choices=UserTypes.get_choices(), default=UserTypes.STUDENT.value)
...
class Profile(Timestamp):
    ...
    university_name = models.CharField(max_length=200, blank=True, null=True, default="")
